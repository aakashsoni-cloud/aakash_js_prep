...
// start from left and calculate sum till the kth element
// maximize the maximum points by left sum 
// start from right and calculate sum till the 0th element with removing the value from left sum
// maximize the sum by right sum + left sum

function maxCards(cards, k) {
  let lsum = 0;
  let rsum = 0;
  let maxLength = 0;
